...
interface MainDisplayProps {
  ...
  onPublishPost: (postInfo: PostInfo) => Promise<void>; // New prop for direct publishing
        ...
        <Suspense fallback={<div>Loading...</div>}>
          ...
          {activeTab === 'personas' && (
              <PersonasDisplay
                ...
                isLoading={isLoadingPersonasData}
                generatedImages={generatedImages}
                onTogglePersonaState={onTogglePersonaState}
              />
          )}
