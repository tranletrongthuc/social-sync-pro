...
import { BRANDS_SCHEMA, listMediaPlanGroupsForBrand, loadProjectFromAirtable, findRecordByField, fetchFullRecordsByFormula, fetchRecordsByLinkedCustomId } from '../services/airtableService';
...
jest.mock('../services/airtableService', () => {
  ...
  return {
    ...
    fetchRecordsByLinkedCustomId: jest.fn(),
  };
});
  ...
  describe('listMediaPlanGroupsForBrand function', () => {
    it('should query Media_Plans table directly instead of using brand fields', async () => {
      await act(async () => {
        ...
        const result = await listMediaPlanGroupsForBrand('brand-123');
  ...
  describe('loadProjectFromAirtable function', () => {
    it('should query child tables directly instead of using brand linked fields', async () => {
      await act(async () => {
        ...
        const result = await loadProjectFromAirtable('brand-123');
