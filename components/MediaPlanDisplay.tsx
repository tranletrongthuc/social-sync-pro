...
const MediaPlanDisplay: React.FC<MediaPlanDisplayProps> = (props) => {
    ...
    const T = {
        ...
        'English': { 
            ...
            selection_gen_comment: "Gen. Comments",
    ...
    const allPostsFlat: PostInfo[] = useMemo(() => {
        if (!selectedPlan) return [];
        
        return (selectedPlan.plan || []).flatMap((week, weekIndex) =>
    ...
    const displayedPosts = useMemo(() => {
        let filteredPosts = [...allPostsFlat];
    ...
    }, [allPostsFlat, searchQuery, selectedPlatforms, selectedStatuses, sortBy, props.generatedImages]);
